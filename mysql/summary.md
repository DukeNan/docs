...
![mysql_07](../_media/images/mysql/mysql_07.jpeg)

32 道 MySQL 的问题：

![mysql_08](../_media/images/mysql/mysql_08.jpeg)

**图片中的答案可以点击这个链接查看：**[32 道 MySQL 面试题总结（含答案解析和思维导图）](https://www.cxyxiaowu.com/16302.html)

### MySQL架构

和其它数据库相比，MySQL有点与众不同，它的架构可以在多种不同场景中应用并发挥良好作用。主要体现在存储引擎的架构上，**插件式的存储引擎架构将查询处理和其它的系统任务以及数据的存储提取相分离**。这种架构可以根据业务的需求和实际需要选择合适的存储引擎。

![mysql_09](../_media/images/mysql/mysql_09.jpeg)
...
![mysql_10](../_media/images/mysql/mysql_10.png)
...
<img src="../_media/images/mysql/mysql_11.jpeg" alt="mysql_11" style="zoom: 56%;" />
![mysql_12](../_media/images/mysql/mysql_12.jpeg)
![mysql_13](../_media/images/mysql/mysql_13.jpeg)
...
![mysql_14](../_media/images/mysql/mysql_14.jpeg)
...
![mysql_15](../_media/images/mysql/mysql_15.jpeg)
...
![mysql_16](../_media/images/mysql/mysql_16.jpeg)
...
![mysql_17](../_media/images/mysql/mysql_17.jpeg)
...
![mysql_18](../_media/images/mysql/mysql_18.jpeg)
...
![mysql_19](../_media/images/mysql/mysql_19.jpeg)
...
- 总结
  ...
  ![mysql_20](../_media/images/mysql/mysql_20.jpeg)

> mysql 的内连接、左连接、右连接有什么区别？什么是内连接、外连接、交叉连接、笛卡尔积呢？

#### Join图

![mysql_21](../_media/images/mysql/mysql_21.jpeg)
...
![mysql_22](../_media/images/mysql/mysql_22.jpeg)
...
![mysql_23](../_media/images/mysql/mysql_23.jpeg)
...
<img src="../_media/images/mysql/mysql_24.png" alt="mysql_24" align="left" />
...
<img src="../_media/images/mysql/mysql_25.png" alt="mysql_25" align="left" />
...
<img src="../_media/images/mysql/mysql_26.jpeg" alt="mysql_26" align="left" />
...
- ![mysql_27](../_media/images/mysql/mysql_27.jpeg)
...
跨库联合查询的问题，可能需要两次查询 跨节点的count、order by、group by以及聚合函数问题，可能需要分别在各个节点上得到结果后在应用程序端进行合并 额外的数据管理负担。

如：访问数据表的导航定位 额外的数据运算压力，如：需要在多个节点执行，然后再合并计算程序编码开发难度提升，没有太好的框架解决，更多依赖业务看如何分，如何合，是个难题。
...
![mysql_28](../_media/images/mysql/mysql_28.jpeg)
